...
namespace ConsoleRenderer
{
    ...
    {
        AnsiEscapes::MoveCursorTo(text_boxes.size() + border_thicknes + to_render.pos.y, (border_thicknes + to_render.pos.x) * 2 - 1);
    ...
    {
        AnsiEscapes::SetBackgroundColor(Colors::RESET_COLOR);
        AnsiEscapes::MoveCursorTo(text_boxes.size() + border_thicknes + to_delete.y, (border_thicknes + to_delete.y * 2) + 1);
        printf("  ");
    }
    //Logic
