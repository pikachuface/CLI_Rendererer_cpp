...
int main()
{
    ...
    ConsoleRenderer::Renderer *rn = new Renderer(10, 20, 2, 2, ConsoleRenderer::Colors::WHITE_BKG);
    ConsoleRenderer::RenderableObject object(1, 1, ConsoleRenderer::Colors::RED_BKG);
    rn->TryAddToRenderQueue(object);
    rn->TryAddTextBox("msg", "Ahoj ", "jak se vede?", Colors::CYAN_TXT, Colors::GREEN_TXT);
    rn->Init();
    object.pos.x += 4;
